...
import 'package:sc/ui_setting/ui_color_theme.dart';
...
class UITextTheme {
  ...
  static final display4_size = 32.0;
  static final display3_size = 30.0;
  static final display2_size = 28.0;
  static final display1_size = 26.0;
  static final headline_size = 24.0;
  static final subhead_size = 22.0;
  static final title_size = 20.0; // 기준점
  static final subtitle_size = 18.0;
  static final body_size = 16.0;
  static final texSection_size = 14.0;
  static final caption_size = 12.0;
  ...
  body.copyWith(color: UIColorTheme.maincolor_50);
