...
class AppTheme {
  ...
  // (2) 폰트사이즈 정의 -----------------------------------------------------------
  static final display4_size = ScreenUtil().setSp(48.0);
  static final display3_size = ScreenUtil().setSp(46.0);
  static final display2_size = ScreenUtil().setSp(44.0);
  static final display1_size = ScreenUtil().setSp(42.0);
  static final headline_size = ScreenUtil().setSp(40.0);
  static final subhead_size = ScreenUtil().setSp(38.0);
  static final title_size = ScreenUtil(allowFontScaling: true).setSp(36); // 기준점
  static final subtitle_size = ScreenUtil(allowFontScaling: true).setSp(34);
  static final body2_size = ScreenUtil(allowFontScaling: true).setSp(32);
  static final texSection_size = ScreenUtil(allowFontScaling: true).setSp(30);
  static final caption_size = ScreenUtil(allowFontScaling: true).setSp(28);
