...
class UITextTheme {
  ...
  static final subtitleSize = 18.0;
  static final bodySize = 13.0;
  static final texSectionSize = 14.0;
  ...
  static final TextStyle display4 = TextStyle(
    ...
    color: UIColorTheme.fontColor_800,
    //letterSpacing: 0.4,
    //height: 0.9,
  );
  ...
  display3.copyWith(color: UIColorTheme.fontColor_50);
  ...
  display2.copyWith(color: UIColorTheme.fontColor_50);
  ...
  display1.copyWith(color: UIColorTheme.fontColor_50);
  ...
  headline.copyWith(color: UIColorTheme.fontColor_50);
  ...
  subhead_white.copyWith(color: UIColorTheme.fontColor_50);
  ...
  title.copyWith(color: UIColorTheme.fontColor_50);
  ...
  subtitle.copyWith(color: UIColorTheme.fontColor_50);
  ...
  body.copyWith(color: UIColorTheme.fontColor_50);
  ...
  textSection.copyWith(color: UIColorTheme.fontColor_50);
  ...
  caption.copyWith(color: UIColorTheme.fontColor_50);
  ...
  buttonText.copyWith(color: UIColorTheme.fontColor_50);
